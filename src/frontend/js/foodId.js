...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveFoodAnalysis() {
        ...
        setTimeout(() => {
            saveAnalysisBtn.innerHTML = '<i class="fas fa-bookmark"></i> Save Analysis';
    ...
    function resetScanner() {
        ...
        if (barcodeOption.classList.contains('active')) {
            barcodeScanner.style.display = 'block';
            if (scannerInitialized) {
                initQuagga();
            } else {
        ...
        } else if (manualOption.classList.contains('active')) {
            manualInput.style.display = 'block';
            barcodeInput.value = '';
        } else if (searchOption.classList.contains('active')) {
            searchResults.style.display = 'block';
        } else if (plateAnalysisOption.classList.contains('active')) {
            plateAnalysis.style.display = 'block';
            resetImageAnalysis();
        }
    }
